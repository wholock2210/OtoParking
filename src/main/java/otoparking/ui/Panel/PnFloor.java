...
import otoparking.DAO.FloorDAO;
import otoparking.model.Floor;
...
public class PnFloor extends JPanel{
    private static final long serialVersionUID = 1L;

	/**
	 * Create the panel.
	 */
	public PnFloor(JPanel pnContent, CardLayout cl) {
